...
## change the setup file to use another dataset, like full (including the Healthy Volunteers)
...
save_graph <- function(graph, name, path = "", width = 8, height = 10){
  ...
  ggplot2::ggsave(filename = paste0(name, ".png"), 
         plot = graph, 
         path = here::here("figures/final_phase", path), 
