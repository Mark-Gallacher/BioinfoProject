#!/bin/bash -l
#SBATCH --account=none
#SBATCH --job-name=py-phase_1   # create a short name for your job
...
python3 "run_phase_1_pipeline.py" --mode "${MODE}" \
...
bash ${bash_script_home}/concatenate.sh "${MODE}_phase_1" \
